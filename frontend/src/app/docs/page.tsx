        ...
        <div className="max-w-4xl mx-auto relative px-4">
          ...
          {[
            { 
              step: 1, 
              title: "1. Connect ERP", 
              desc: "Borrower connects accounting software (QuickBooks/Stripe/ERPNext) to the protocol securely via OAuth. No manual document uploads.", 
            ...
            { 
              ...
              desc: "A Zero-Knowledge cryptographic proof is generated, mathematically proving the invoice is valid without leaking your private client data to the public.", 
